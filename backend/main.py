...
def seed_database(db: Session = Depends(get_db)):
    ...
    song1 = models.Song(
        ...
        language="Deutsch",
        sheet_music_url="http://localhost:8000/uploads/wacht_am_rhein_noten.jpg",
...
Ich bin ein Preuße, will ein Preuße sein.""",
    ...
    p1 = models.ArchiveItem(
        ...
        image_url="http://localhost:8000/uploads/pc_14.jpg", 
        year=1914, 
        item_type="Postkarte",
    ...
    p2 = models.ArchiveItem(
        ...
        image_url="http://localhost:8000/uploads/pc1.jpg", 
        year=1914, 
        item_type="Postkarte",
        category_id=cat_postcards.id
    )
    p3 = models.ArchiveItem(
        ...
        image_url="http://localhost:8000/uploads/pc2.jpg", 
        year=1914, 
        item_type="Postkarte",
        category_id=cat_postcards.id
    )
    p4 = models.ArchiveItem(
        ...
        image_url="http://localhost:8000/uploads/pc3.jpg", 
        year=1914, 
        item_type="Postkarte",
        category_id=cat_postcards.id
    )
    p5 = models.ArchiveItem(
        ...
        image_url="http://localhost:8000/uploads/pc6.jpg", 
        year=1914, 
        item_type="Postkarte",
        category_id=cat_postcards.id
    )
    p6 = models.ArchiveItem(
        ...
        image_url="http://localhost:8000/uploads/pc5.jpg", 
        year=1914, 
        item_type="Postkarte",
        category_id=cat_postcards.id
    )
    p7 = models.ArchiveItem(
        ...
        image_url="http://localhost:8000/uploads/pc0.jpg", 
        year=1914, 
        item_type="Postkarte",
        category_id=cat_postcards.id
    )
    p8 = models.ArchiveItem(
        ...
        image_url="http://localhost:8000/uploads/pc8.jpg", 
        year=1914, 
        item_type="Postkarte",
        category_id=cat_postcards.id
    )
    ...
    for i in range(3, 18):
        ...
        vordrucke.append(models.ArchiveItem(
            ...
            image_url=f"http://localhost:8000/uploads/IMG-20251228-WA{idx}.jpg",
            year=1914,
            item_type="Vordruck",
            category_id=cat_postcards.id
        ))
